...
export default function AdminProductEdit({ product, categories, variantGroups, productMedia, exchangeRate, deliveryRate }: EditProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        delivery_rate_batam: String((product as any).delivery_rate_batam ?? 0),
        delivery_rate_jakarta: String((product as any).delivery_rate_jakarta ?? 0),
