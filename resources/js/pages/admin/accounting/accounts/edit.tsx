...
export default function AccountEdit({ account, accounts, types }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        setProcessing(true);
        router.put(`/admin/accounting/accounts/${account.id}`, form, {
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <Input
                                        value={normalBalanceForType(form.type)}
                                        readOnly
