...
import type { Page } from '@/types/settings';
...
export default function AdminPageEdit({ page }: Props) {
    const { data, setData, put, processing, errors, transform } = useForm({
        slug: page.slug,
        footer_section: page.footer_section ?? 'none',
        sort_order: String(page.sort_order),
        is_active: page.is_active,
        translations: {
            en: { title: page.translations.en?.title ?? '', content: page.translations.en?.content ?? '' },
            id: { title: page.translations.id?.title ?? '', content: page.translations.id?.content ?? '' },
    ...
    const submit = (e: React.FormEvent) => {
        ...
        put(`/admin/settings/pages/${page.id}`, {
    ...
    return (
        <AdminLayout breadcrumbs={[
            ...
            <form onSubmit={submit}>
                <AdminPageHeader
                    title="Edit Page"
                    subtitle="Update this static content page."
                    actions={
                        <>
