...
export default function AdminSocialLinkCreate() {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post('/admin/settings/social-links', {
            onSuccess: () => toast.success('Social link created successfully'),
        ...
        <AdminLayout breadcrumbs={[
            ...
            <form onSubmit={submit}>
                <AdminPageHeader
                    ...
                    subtitle="Add a new social media link to the storefront footer."
                    actions={
                        <>
