...
export default function AdminCategoryCreate({ categories }: { categories: Category[] }) {
                                ...
                                {imagePreview ? (
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button type="button" variant="destructive" onClick={() => { setImage(null); setImagePreview(null); }}>
                                                Remove
                                            </Button>
                                        </div>
                                    </div>
