...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'verified', 'permission:admin.access'])->group(function () {
    ...
    Route::post('settings/whatsapp/device-info', [WhatsappSettingController::class, 'deviceInfo'])->name('settings.whatsapp.device-info')->middleware('permission:settings.edit');
